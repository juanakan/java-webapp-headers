...
import org.juan.apiservlet.webapp.headers.services.ProductoService;
import org.juan.apiservlet.webapp.headers.services.ProductoServiceImpl;
    ...
    protected void doPost(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        ...
        if (encontrado.isPresent()){
            ...
            try(PrintWriter out = resp.getWriter()){
                ...
                out.println("        <h3>Producto: "+ encontrado.get().getNombre()+ "</h3>");
                out.println("        <h3>Precio: "+ encontrado.get().getPrecio()+ "</h3>");
                out.println("        <h3>Tipo: "+ encontrado.get().getTipo()+ "</h3>");
                out.println("    </body>");
                out.println("</html>");
